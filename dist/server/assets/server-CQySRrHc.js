...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-ZmAJSMyw.js");
...
const manifest = {
  "74404dd995358838a5931235b65a01a36b76503fa957a39208125146b6b8e585": {
    functionName: "verifyFlutterwavePayment_createServerFn_handler",
    importer: () => import("./payments.functions-SJPmqALr.js")
  },
  "b6cd6f639b0395ed6343660394aa0c5a941b7c8557ba00c028aad95c3fb2ddc3": {
    functionName: "initiateFlutterwavePayment_createServerFn_handler",
    importer: () => import("./payments.functions-SJPmqALr.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-x3seCsFL.js").then((n) => n.r),
    import("./start-DFZ7d2tf.js"),
